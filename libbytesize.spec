...
Source0  : https://github.com/storaged-project/libbytesize/releases/download/2.8/libbytesize-2.8.tar.gz
...
%prep
%setup -q -n libbytesize-2.8
cd %{_builddir}/libbytesize-2.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1680633377
