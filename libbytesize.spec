...
Source0  : https://github.com/storaged-project/libbytesize/releases/download/2.10/libbytesize-2.10.tar.gz
...
%prep
%setup -q -n libbytesize-2.10
cd %{_builddir}/libbytesize-2.10
pushd ..
cp -a libbytesize-2.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720049149
