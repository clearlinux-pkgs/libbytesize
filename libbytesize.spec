...
Source0  : https://github.com/storaged-project/libbytesize/releases/download/2.4/libbytesize-2.4.tar.gz
...
%prep
%setup -q -n libbytesize-2.4
cd %{_builddir}/libbytesize-2.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611622157
...
cp %{_builddir}/libbytesize-2.4/LICENSE %{buildroot}/usr/share/package-licenses/libbytesize/507ba5f4949dedff9e01b4d5b64b365fdc7d4d04
%make_install
