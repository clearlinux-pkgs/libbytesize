...
Source0  : https://github.com/storaged-project/libbytesize/releases/download/2.7/libbytesize-2.7.tar.gz
...
%prep
%setup -q -n libbytesize-2.7
cd %{_builddir}/libbytesize-2.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658940399
